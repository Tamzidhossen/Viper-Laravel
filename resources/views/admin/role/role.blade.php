    ...
    @can('role_access')
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h3 class="text-white text-center">Role List</h3>
                    </div>
                    <div class="card-body">
            ...
            {{-- <div class="col-lg-4">
                <div class="card mt-3">
                    <div class="card-header bg-primary">
                        <h3 class="text-white text-center">Add New Permission</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($users as $index=>$user)
                                <tr>
                                    ...
                                    <td><a href="{{ route('role.remove', $user->id) }}" class="btn btn-danger">Remove</a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card mt-3">
                    <div class="card-header bg-primary">
                        <h3 class="text-white text-center">Add New Role</h3>
                    </div>
                    <div class="card-body">
